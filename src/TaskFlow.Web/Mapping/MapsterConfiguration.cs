...
public static class MapsterConfiguration
{
    public static void RegisterMappings()
    {
        ...
        TypeAdapterConfig<TaskItemDetailsDto, UpdateTaskItemViewModel>
            .NewConfig();

        TypeAdapterConfig<UpdateTaskItemViewModel, UpdateTaskItemCommand>
            .NewConfig();

        TypeAdapterConfig<MoveTaskItemViewModel, MoveTaskItemCommand>
            .NewConfig();

        TypeAdapterConfig<DashboardDto, DashboardViewModel>
            .NewConfig();
    }
}